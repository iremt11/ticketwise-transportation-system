...
public class Train extends Vehicle{
    public Train(String companyName, String vehicleType, String licensePlate, int capacity, long registrationNumber) {
    ...
    public void addVehicle(String companyName, String vehicleType, String licensePlate, int capacity, long registrationNumber) {
        Vehicle newTrain = new Train(companyName, vehicleType, licensePlate, capacity, registrationNumber);
        vehicles.add(newTrain);
        writeToFile("vehicles.txt",newTrain);
    ...
    public void readFromFile(String filename) {
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                Vehicle vehicle = new Train(data[0], data[1], data[2], Integer.parseInt(data[3]), Long.parseLong(data[4]));
