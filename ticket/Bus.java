...
public class Bus extends Vehicle {
    ...
    public Bus(String companyName, String vehicleType, String licensePlate, int capacity, long registrationNumber) {
    ...
    public void addVehicle(String companyName, String vehicleType, String licensePlate, int capacity, long registrationNumber) {
        Vehicle newBus= new Bus(companyName, vehicleType, licensePlate, capacity, registrationNumber);
        vehicles.add(newBus);
        writeToFile("vehicles.txt",newBus);
    }
    ...
    public void readFromFile(String filename) {
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                Vehicle vehicle = new Bus(data[0], data[1], data[2], Integer.parseInt(data[3]), Long.parseLong(data[4]));
